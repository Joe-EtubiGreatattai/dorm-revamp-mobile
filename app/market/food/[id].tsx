...
export default function FoodDetail() {
    ...
    const [isOrderConfirmVisible, setOrderConfirmVisible] = useState(false);
    ...
    if (isLoading) {
        return (
            <>
                ...
                <CustomLoader message="Loading meal details..." />
            </>
        );
    }
        ...
        return (
            <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: colors.text, marginTop: 16 }}>Food item not found</Text>
    ...
    const handleTrackOrder = () => {
        ...
        if (purchasedOrderId) {
            router.push(`/tracker/${purchasedOrderId}?type=food`);
        }
    };
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.content}>
                    <View style={styles.headerInfo}>
                        <View style={styles.badgeRow}>
                            <View style={[styles.typeBadge, { backgroundColor: colors.primary + '20' }]}>
                                <Text style={[styles.typeBadgeText, { color: colors.primary }]}>{item.category || 'Food'}</Text>
                            </View>
                            {item.dietary?.map((tag: string) => (
                                <View key={tag} style={[styles.tagBadge, { backgroundColor: colors.border }]}>
                                    <Text style={[styles.tagBadgeText, { color: colors.subtext }]}>{tag}</Text>
                                </View>
                            ))}
                        </View>
                        ...
                        <View style={styles.metaRow}>
                            <View style={styles.metaItem}>
                                ...
                                <Text style={[styles.metaText, { color: colors.subtext }]}>{item.prepTime || '30 min'}</Text>
                            </View>
                            <View style={styles.metaDivider} />
                            <View style={styles.metaItem}>
                                <Ionicons name="flame-outline" size={18} color={colors.subtext} />
                                <Text style={[styles.metaText, { color: colors.subtext }]}>{item.calories || 'N/A'} kcal</Text>
                            </View>
                        </View>
                    ...
                    <View style={styles.descriptionSection}>
                        <Text style={[styles.sectionTitle, { color: colors.text }]}>Chef's Note</Text>
                    ...
                    <View style={[styles.infoBox, { backgroundColor: colors.primary + '10' }]}>
                        ...
                        <Text style={[styles.infoBoxText, { color: colors.primary }]}>
                            This is a home-cooked meal prepared with student love.
                        </Text>
                    </View>
                </View>
            </ScrollView>
            ...
            <ActionSuccessModal
                ...
                title="Order Placed!"
                description={`Your order for ${item.title} has been sent to ${seller.name}.`}
